...
#include "htscope1Version.h"

/* must be last include */
#include "epicsExport.h"

const char version[] = htscope1VERSION;
...
static lsidset devhtscope1Version = {
	{5, NULL, NULL, NULL, NULL}, read_string
};
epicsExportAddress(dset,devhtscope1Version);
